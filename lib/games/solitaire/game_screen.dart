...
class GameScreen extends StatefulWidget {
  ...
  const GameScreen({Key? key, this.onWin}) : super(key: key);
...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget _buildCardDeck() {
    final placeholderCard = PlayingCard(
          ...
          child: cardDeckClosed.isNotEmpty
              ? Padding(
                  ...
                  child: TransformedCard(
                    ...
                    attachedCards: [cardDeckClosed.last],
                    columnIndex: 0,
                  ),
                )
              : Opacity(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(4.0),
                    child: TransformedCard(
                      playingCard: placeholderCard,
                      attachedCards: [placeholderCard],
                      columnIndex: 0,
                    ),
                  ),
                ),
  ...
  void _handleWin() {
    widget.onWin?.call(); // 🔥 Fal uygulamasına coin kazandırmak için
